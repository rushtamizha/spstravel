      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-slate-600">
            Pick from sedans, SUVs, premium vans, and buses tailored for one-way
            or round-trip travel, with extra charges clearly noted.
          </p>
        </div>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                          {fleet.priceOneWay && (
                            <span>Oneway Trip: {fleet.priceOneWay} | </span>
                          )}
                          {fleet.priceRoundTrip && (
                            <span>Round Trip: {fleet.priceRoundTrip}</span>
                          )}
                        </p>
                      </div>
                ...
                <div className="border-b border-green-100 bg-gradient-to-br from-green-50 via-white to-white p-6 lg:border-b-0 lg:border-r">
                  <div className="rounded-[1.75rem] border border-green-100 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-3 text-sm">
                      <MiniStat
                        label="One Way"
                        value={selectedFleet.priceOneWay}
                      />
                      <MiniStat
                        label="Round Trip"
                        value={selectedFleet.priceRoundTrip}
                      />
                      <MiniStat
                        label="Capacity"
                        value={selectedFleet.capacity}
                      />
                      <MiniStat label="Luggage" value={selectedFleet.luggage} />
                      <MiniStat
                        label="Driver Beta"
                        value={selectedFleet.driverBeta}
                      />
                      <MiniStat label="Call" value="+91 9677792455" />
                    </div>
